          ...
          <div class="col-md-4 no-gutter">
              ...
              <div class="alert alert-danger" role="alert">
                ...
                <form class="">
                  <div class="form-group">
                    ...
                    <input class="es_textbox_class col-md-9 col-sm-10 form-control" placeholder="ایمیل خود را اینجا وارد کنید.." name="es_txt_email_pg" id="es_txt_email_pg" onkeypress="if(event.keyCode==13) es_submit_pages('http://localhost/wp.orgin')" value="" maxlength="225" type="text">

                    <span class="input-group-btn col-md-3 col-sm-2 subscribe">
            ...
            <div class="col-md-12 social text-center">
              ...
              <ul class="list-unstyled">
                ...
                <li><a id="linkedin" href="http://www.linkedin.com/in/<?php echo $linkedinID; ?>" target="_blank"><img class="img-rounded" data-toggle="tooltip" data-placement="bottom" title="لینکداین" src="<?php bloginfo('template_directory'); ?>/images/linkedin.svg" alt=""></a></li>
                ...
                <!-- http://www.google-plus.com/<?php $googlePlusID; ?> -->
                <li><a id="google-plus" href=""><img class="img-rounded" data-toggle="tooltip" data-placement="bottom" title="گوگل پلاس" src="<?php bloginfo('template_directory'); ?>/images/google-plus.svg" alt=""></a></li>
